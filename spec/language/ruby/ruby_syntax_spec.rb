...
RSpec.describe Languages::RubySyntax do
  ...
  context "Extern requirement detections." do
    ...
    it "Correct data capture (require_relative)." do
      ...
      @syntax.analyse_source(path)
      expect(@syntax.fileElements[0].extern_requirements[0].path).to eq ("one")
      expect(@syntax.fileElements[0].extern_requirements[1].path).to eq ("two")
      expect(@syntax.fileElements[0].extern_requirements[2].path)
        .to eq ("three")
      expect(@syntax.fileElements[0].extern_requirements[3].path)
        .to eq ("four")
      expect(@syntax.fileElements[0].extern_requirements[4].path)
        .to eq ("five")
      expect(@syntax.fileElements[0].extern_requirements[5].path).to eq ("six")
    ...
    it "Correct data capture (require)." do
      ...
      expect(@syntax.fileElements[0].extern_requirements[4].path)
        .to eq ("five")
      expect(@syntax.fileElements[0].extern_requirements[5].path).to eq ("six")
      expect(@syntax.fileElements[0].extern_requirements[6].path)
        .to eq ("seven")
      expect(@syntax.fileElements[0].extern_requirements[7].path)
        .to eq ("eight")
      expect(@syntax.fileElements[0].extern_requirements[8].path)
        .to eq ("nine")
