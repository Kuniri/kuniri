...
RSpec.describe Kuniri::Kuniri do
  ...
  before :each do
    ...
    @output = File.open("./spec/language/ruby/global_test/conditional/veryMixConditional.xml", "r")
  end

  context "Very mix conditional" do
    it "Find: case p" do
      conditional = nil
      @output.each do |line|
    ...
    it "Find: elsif banana == level1" do
      conditional = nil
      @output.each do |line|
