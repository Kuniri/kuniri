...
module Languages
  ...
  class VariableBehaviour
    ...
    def common_declaration(_pLine)
      raise NotImplementedError
    end

    protected

    TMP_TOKEN_COMMA = '<comma>'.freeze
    TMP_TOKEN_EQUAL = '<equal>'.freeze
    TMP_HASH_SIMBOL = '<hash>'.freeze
    ...
    def replace_strings_and_params(_pLine)
      raise NotImplementedError
    end
    ...
    def replace_commas_inside_brackets_and_braces(_pLine)
      raise NotImplementedError
    end
    ...
    def build_hash_of_variables_and_values(_pVariablesList, _pStringsValues)
      raise NotImplementedError
    end
    ...
    def process_value(_pValue, _pStrings)
      raise NotImplementedError
    end

    # Replace final tokens from string
    def normalize_elements(_pVariables)
      raise NotImplementedError
    end
  end # Class
end # Language
